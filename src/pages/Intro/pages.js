export const introPages = [
...

    {
        ...
        title: {
            it: "Dall'immagine al progetto.",
            en: "From image to design.",
        },

        subtitle: {
            it: "Percorso · Fotografia · Digitale",
            en: "Background · Photography · Digital",
        },
...

    {
        ...
        title: {
            it: "Tre problemi, tre soluzioni.",
            en: "Three problems, three solutions.",
        },

        subtitle: {
            it: "Hospitality · Editorial · Digital",
            en: "Hospitality · Editorial · Digital",
        },

        items: {
            it: [
                "01 - Berretta Rossa · Dare identità a un luogo",
                "02 - Bobina Criminale · Dare voce a un progetto editoriale",
                "03 - MOA · Rendere semplice un sistema complesso",
            ],

            en: [
                "01 - Berretta Rossa · Giving a place its identity",
                "02 - Bobina Criminale · Giving an editorial project its voice",
                "03 - MOA · Making a complex system feel simple",
            ],
        },
    },
];